...
public class ShockwaveController : MonoSingleton<ShockwaveController>
{
    ...
    [SerializeField] private float _startDistance = 0.2f;
    [SerializeField] private float _endDistance = 1f;
    ...
    public void CallShockWave(Transform center)
    {
        ...
        _shockWaveCoroutine = StartCoroutine(HandleShockWave(_startDistance, _endDistance));       
    }
